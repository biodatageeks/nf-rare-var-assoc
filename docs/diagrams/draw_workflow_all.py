...
# direction="LR",
with Diagram("Nextflow gene-level associacion pipeline - all", direction="TB", graph_attr=graph_attr, node_attr=node_attr, outformat=['png', 'svg', 'dot']):
    ...
    with cluster("Data Preprocessing"):
        ...
        exploratory_data_analysis = container(
            name="Python script",
            description="Iput Data Characteristics Analysis",
        )
        ...
        input_pvcf_file >> Relationship("") >> exploratory_data_analysis
        #exploratory_data_analysis >> Relationship("") >> eda_diagrams
        
        input_pvcf_file >> Relationship("") >> bcftools_quality_filtering
    ...
    with cluster("Regenie"):
        ...
        extract_gnomad_allele_freq >> Relationship("", constraint="false") >> rscript_prepare_annotations
        plink_missingness_per_pheno >> Relationship("", constraint="false") >> plink_pgen
    ...
    plink_missingness_per_pheno >> Relationship("", constraint="false") >> plink_f_filtering
    
    regenie_step_2 >> Relationship("") >> build_reports
    #eda_diagrams >> Relationship("") >> build_reports
    #exploratory_data_analysis >> Edge(
	#	style = "dashed",
	#	color = "gray60",
	#	label = _format_edge_label("Input Data Characteristics Plots")
	#) >> build_reports
	...
	#	style = "dashed",
	#	color = "gray60",
	#	label = _format_edge_label("Principal Components Plots")
	#) >> build_reports
