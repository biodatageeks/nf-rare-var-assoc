...
<small>
This report has been created with **[rare-var-assoc-nf `r params$version`](https://github.com/biodatageeks/rare-var-assoc-nf)**, a nextflow pipeline developed by [Piotr Suszyński](mailto:piotr.suszynski.dokt@pw.edu.pl), [Anna Lewan] and [Tomasz Gambin](mailto:tomasz.gambin@pw.edu.pl), Politechnika Warszawska. The Manhattan and QQ plots reporting was adapted from **[nf-gwas `r params$version`](https://github.com/genepi/nf-gwas)**, a nextflow pipeline developed by [Sebastian Schönherr](mailto:sebastian.schoenherr@i-med.ac.at), [Lukas Forer](mailto:lukas.forer@i-med.ac.at) and [Johanna Schachtl-Riess](mailto:johanna.schachtl-riess@i-med.ac.at), Institute of Genetic Epidemiology, Medical University of Innsbruck.
</small>
