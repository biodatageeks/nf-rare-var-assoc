process BCFTOOLS_FILTER_QUAL_DP {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/vcftools:v0.1.16-1-deb_cv1':
    ...
    #    --minDP 10 --maxDP 100 --recode --recode-INFO-all \\
    vcftools \\
        --gzvcf ${vcf} \\
        $args \\
        --stdout > ${prefix}_${out_name_part}.vcf

    # TODO: get number of input/output variants/samples
    ...
    {
        "process_name": "${task.process}_${out_name_part}_${prefix}",
    ...
    "${task.process}":
        vcftools: \$(vcftools --version 2>&1 | head -n1 | sed 's/^.*vcftools //; s/ .*\$//')
    END_VERSIONS
    """
