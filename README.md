...
> the images and containers, or for storing temporary files, the user may want to set a
> relevant environment variable, such as NXF_APPTAINER_CACHEDIR, NXF_TEMP, NXF_CACHE_DIR and
> TMPDIR.
>
